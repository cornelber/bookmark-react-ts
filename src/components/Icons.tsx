    ...
    <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
      <g fill="none" fillRule="evenodd">
        <path
          ...
          fill={isOnDark ? "#fff" : "#242A45"}
          fillRule="nonzero"
          className="transition-colors duration-300"
        />
        <g>
          <circle
            fill={isOnDark ? "#fff" : "#5267DF"}
            cx="12.5"
            cy="12.5"
            r="12.5"
            className="transition-colors duration-300"
          ...
          <path
            ...
            fill={isOnDark ? "rgba(37,43,70,0.95) " : "#fff"}
            className="transition-colors duration-300"
          />
        </g>
      </g>
...
// Social Icons
export const SocialIcons = ({ wrapperClassName = "" }: SocialIconsProps) => {
  const commonIconClasses =
    "text-icon text-icon-white hover:text-icon-red transition-colors duration-300";

  return (
    <div className={clx("flex", wrapperClassName)}>
      <Link
        ...
        aria-label="Facebook"
      >
        <i className={`icon-icon-facebook ${commonIconClasses}`} />
      </Link>
      <Link
        to="https://x.com/"
        target="_blank"
        ...
        aria-label="Twitter"
      >
        <i className={`icon-icon-twitter ${commonIconClasses}`} />
      </Link>
    </div>
  );
};
